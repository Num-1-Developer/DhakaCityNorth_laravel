        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-5 align-self-center">
                    <h4 class="page-title">থানার দায়িত্বাভার ব্যক্তির তথ্য</h4>
                </div>
                ...
                <div class="col-12 w-75 m-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/update_thana_rs_info/{{$data_thana_rs->id}}"  method="POST" class="form-horizontal form-material mx-2" enctype="multipart/form-data">
                              @csrf
                              @method('put')
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <div class="col-sm-12" style="width: 75%;">
                                        <input name='rp_name' type="text" placeholder="নাম" class="form-control form-control-line" value="{{$data_thana_rs->rp_name}}">
                                    </div>
                                </div>
                                <div class="form-group d-flex">
                                    <label class="col-sm-12" style="width: 25%;">  মোবাইল নম্বর</label>
                                    <div class="col-sm-12" style="width: 75%;">
                                        <input name='rp_phone' type="text" placeholder=" মোবাইল নম্বর" class="form-control form-control-line"  value="{{$data_thana_rs->rp_phone}}">
                                    </div>
                                </div>
                                <div class="form-group d-flex">
                                    <label class="col-sm-12" style="width: 25%;"> ভোটার নং</label>
                                    <div class="col-sm-12" style="width: 75%;">
                                        <input name='rp_nid' type="text" placeholder="ভোটার নং" class="form-control form-control-line" value="{{$data_thana_rs->rp_nid}}">
                                    </div>
                                </div>
