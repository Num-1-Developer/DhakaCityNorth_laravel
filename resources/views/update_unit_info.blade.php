                ...
                <div class="col-12 w-75 m-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="/update_unit_info/{{$data_u->id}}" class="form-horizontal form-material mx-2">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group d-flex">
                                    <label class="col-sm-12" style="width: 25%;"> ইউনিয়নের নাম</label>
                                    <div class="col-sm-12" style="width: 75%;">
                                        <input name='union_name' type="text" value="{{$data_u->union_name}}" placeholder=" ইউনিয়নের নাম" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group d-flex">
