                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    @foreach($data_join as $data)
                                        ...
                                        <!--  -->
                                            ...
                                            <a  href='/ps_update_page/{{$data->id}}' name="btn_edit" class="btn btn-info" style='line-height: 0.5;padding: .5rem'>edit</a>
                                            <a  href='/ps_delete/{{$data->id}}' name="btn_delete" class="btn btn-danger" style='line-height: 0.5;padding: .5rem'>delete</a>
                                        </td>
