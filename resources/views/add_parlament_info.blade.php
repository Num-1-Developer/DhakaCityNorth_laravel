                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group d-flex">
                          ...
                          <div class="form-group d-flex">
                              ...
                              <div class="col-sm-12" style="width: 75%;">
                                  <input name='no' type="text" placeholder="Number" class="form-control form-control-line">
                              </div>
                          </div>
                          ...
                          <div class="form-group d-flex">
                              ...
                              <div class="col-sm-12" style="width: 75%;">
                                  <button href='insert_p' class="btn btn-success text-white">Submit</button> <button class="btn btn-success text-white">Reset</button>
                              </div>
                          </div>
                      </form>
                  </div>
                          ...
                          <table class="table table-hover table-bordered">
                              ...
                              @foreach($data as $data)
                                  ...
                                  <!--  -->
                                      ...
                                      <a  href='/parlament_update_page/{{$data->id}}' name="btn_edit" class="btn btn-info" style='line-height: 0.5;padding: .5rem'>edit</a>
                                      <a  href='/delete_parlament/{{$data->id}}' name="btn_delete" class="btn btn-danger" style='line-height: 0.5;padding: .5rem'>delete</a>
                                  </td>
